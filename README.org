...
* Notes: I used main.cpp for tasks B and C. Task A is complete but it needs to be tested using make test-ascii and then ./test-ascii.
I'm sorry but I was unable to complete the full lab (part D) in time due to studying for my midterms for 150 and Calculus 2.
